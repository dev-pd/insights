"""Original extraction prompt — never edited after release.

Kept indefinitely so any llm_usage row with prompt_version="extraction/v1"
(or the legacy "v1" naming) can be reproduced against this exact text.
If you want to change behavior, create a new version file alongside —
